        ...
        <div className="container">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {project.tags.length > 2 && (
                      <span className="px-2 py-1 bg-[#E2E8F0] text-[#475569] text-xs rounded-full font-medium">
                        +{project.tags.length - 2}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="pt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 text-accent hover:text-blue-600 font-medium text-sm transition-colors"
                    >
                      View Project
          ...
          <div className="mt-12 text-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-3 bg-accent text-white rounded-lg hover:bg-blue-600 transition-colors font-medium"
            >
